    ...
    "inline-flex glass-nav items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border",
    {
        variants: {
            variant: {
                ...
                outline:
                    "bg-black/[0.04] dark:bg-white/10 border-black/15 dark:border-accent/30 text-foreground dark:text-white shadow-[0_4px_16px_rgba(0,0,0,0.06),inset_0_1px_0_rgba(255,255,255,0.4)] dark:shadow-[0_4px_16px_rgba(0,0,0,0.2),inset_0_1px_0_rgba(255,255,255,0.05)] hover:bg-black/[0.07] dark:hover:bg-white/15 hover:border-black/20 dark:hover:border-accent/50 hover:-translate-y-0.5 active:translate-y-0",
                secondary:
