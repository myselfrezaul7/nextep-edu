    ...
    return (
        <AnimatePresence>
            <motion.a
                ...
                whileTap={{ scale: 0.9 }}
                className="fixed bottom-[6.5rem] md:bottom-6 right-6 z-50 flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-2xl hover:shadow-[#25D366]/40 transition-all duration-300 before:absolute before:inset-0 before:rounded-full before:bg-[#25D366] before:animate-[ping_3s_ease-in-out_infinite] before:opacity-20 flex"
