        ...
        <main className="min-h-screen">
            ...
            <section className="py-16 md:py-24 bg-accent/5">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <a
                        href="https://wa.me/4915147483493?text=Hi%2C%20I%20need%20help%20choosing%20a%20study%20destination"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 via-accent to-yellow-400 text-accent-foreground px-8 py-4 rounded-full font-semibold shadow-lg shadow-accent/25 hover:shadow-xl hover:shadow-accent/35 hover:-translate-y-0.5 transition-all duration-300 border border-white/20"
                    >
